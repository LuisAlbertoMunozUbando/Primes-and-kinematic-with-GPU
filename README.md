...
| [`prime_ik_multi_dof_experiments.ipynb`](./prime_ik_multi_dof_experiments.ipynb) | The **notebook**: the executable form of the paper. Every equation in the PDF is implemented here, and every figure, animation, and CSV in the paper is emitted by running it. |
